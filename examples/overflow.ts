...
hidden.appendChild(pc.createTextNode('This line is intentionally much wider than the blue box and should be clipped.'));

const visible = box('overflow:visible', 'green', 'visible');
visible.appendChild(pc.createTextNode('This line is intentionally much wider than the green box and should spill out.'));
