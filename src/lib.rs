...
impl PaintCannon {
    ...
    pub fn new() -> Self {
        ...
        let input = TerminalInput::start(DEFAULT_SYNTHETIC_KEYUP_MS);
...
impl TerminalInput {
    fn start(synthetic_keyup_delay_ms: u32) -> Option<Self> {
    ...
    fn drain(&self) -> Vec<KeyboardEvent> {
    ...
    fn set_synthetic_keyup_delay(&self, delay_ms: u32) {
